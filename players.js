...
const playersWithPhotos = [
  ...
  },
  {
    ...
    photo: 'https://www.google.com/imgres?q=faker&imgurl=https%3A%2F%2Fliquipedia.net%2Fcommons%2Fimages%2Fthumb%2F9%2F9e%2FT1_Faker_at_Worlds_2025_Finals.jpg%2F600px-T1_Faker_at_Worlds_2025_Finals.jpg&imgrefurl=https%3A%2F%2Fliquipedia.net%2Fleagueoflegends%2FFaker&docid=UVGY4VF060lyjM&tbnid=C1XKFA5roX1vVM&vet=12ahUKEwi21ZGA1JyUAxUw3QIHHSyFPdoQnPAOegr?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==', 
    ig_handle: '@faker', followers: '2.6M'
  },
  {
    nick: 'Miracle-', real: 'Amer Al-Barkawi',
    game: 'Dota 2', country: '🇯🇴', rating: 9780, role: 'Carry', team: 'Nigma Galaxy', wins: 620,
    photo: 'https://images.unsplash.com/photo-1568602471122-7832951cc4c5?w=400&h=500&fit=crop&crop=face',
    desc: 'Dota 2-нің ең техникалық carry ойыншысы. TI жеңімпазы.',
    instagram: 'https://www.instagram.com/miracle_dota2/', ig_handle: '@miracle_dota2', followers: '890K'
  },
  {
  ...
  {
    nick: 'DestinY', real: 'Arman Seitkali',
    game: 'CS2', country: '🇰🇿', rating: 7400, role: 'Entry', team: 'KZ Cyber Team', wins: 310,
    ...
    instagram: 'https://www.instagram.com/destinY/', ig_handle: '@destiny_kz_esports', followers: '45K'
  },
  {
    ...
    instagram: 'https://www.instagram.com/niko_g2/', ig_handle: '@niko_g2', followers: '980K'
  },
];
...
const realTracks = [
  { name:'Cyber Arena',     artist:'Mixkit • Gaming Beat',    emoji:'🎮', dur:'1:30', secs:90,
    url:'https://youtu.be/7amp4q4WP1Q?si=oDGO4W9Ob7zgePNf' },
...
function upgradeMusic() {
  ...
  if (audio) { audio.src = realTracks[0].url; audio.load(); }
...
function renderTelegramSection() {
        ...
        <div class="tg-preview">
          <div class="tg-phone">
            ...
            <div class="tg-cmds-row">
              ...
              <span class="tgc" onclick="tgSend('/CEO')">/CEO</span>
            </div>
            <div class="tg-foot">
  ...
  const cmdDefs = [
    ...
    ['/CEO','Сайттың негізін қалаушы туралы ақпарат'],
  ];
...
const tgReplies = {
  ...
  '/CEO':'👨‍💼 <strong>Компанияның CEO-сы:</strong>\n\n👨‍💼 Шарғын Нұрахмет/NS — CEO\n📧 Instagram: @nnurakhmett.ww',
};
...
function tgSend(cmd) {
  ...
  setTimeout(() => {
    tgBot(tgReplies[text.toLowerCase()] ||
      `❓ Белгісіз: <strong>${text}</strong>\n\nКомандалар: /start /games /teams /tournaments /players /news /about`);
  }, 500);
}
