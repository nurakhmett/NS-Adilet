...
const playersWithPhotos = [
  {
    ...
    photo: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=400&h=500&fit=crop&crop=face',
  ...
  },
  {
    ...
    photo: 'https://images.unsplash.com/photo-1560253023-3ec5d502959f?w=400&h=500&fit=crop&crop=face',
    desc: 'LoL аңызы. 4× Дүниежүзілік чемпион. "Ойынның Құдайы".',
  ...
  },
  {
    ...
    instagram: 'https://www.instagram.com/destiny_kz_esports/', ig_handle: '@destiny_kz_esports', followers: '45K'
  },
  {
...
// ===== 2. НАҚТЫ МУЗЫКА (Mixkit ақысыз треки) =====
const realTracks = [
