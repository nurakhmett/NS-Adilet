...
// ===== MUSIC PLAYER =====
const tracks = [
  { name: 'Cyber Arena', artist: 'Suno AI • Gaming Mix', emoji: '🎮', dur: '3:20', secs: 200 },
  { name: 'Neon Overdrive', artist: 'Suno AI • Synthwave', emoji: '⚡', dur: '4:05', secs: 245 },
  { name: 'Ranked Match', artist: 'Suno AI • Competitive', emoji: '🏆', dur: '3:50', secs: 230 },
  { name: 'Boss Fight', artist: 'Suno AI • Intense', emoji: '💀', dur: '5:12', secs: 312 },
  { name: 'Victory Screen', artist: 'Suno AI • Triumph', emoji: '🥇', dur: '2:48', secs: 168 },
];
...
function selectTrack(i) {
  ...
  document.getElementById('nowEmoji') && (document.getElementById('nowEmoji').textContent = t.emoji);
